...
describe('Test filter model and related utils', () => {
    ...
    describe('Test "FilterColumn"', () => {
        ...
        it('should not calc when filter fn or range is not set', () => {
            ...
            filterColumn.setCondition({ colId: 0, customFilters: { customFilters: [{ operator: CustomFilterOperator.LESS_THAN, val: 123 }] } });
            expect(filterColumn.hasCache()).toBeFalsy();
        ...
        it('should not auto calc when set condition', () => {
            filterColumn = new FilterColumn(
                'test',
                'sheet1',
                get(IUniverInstanceService).getCurrentUniverSheetInstance().getActiveSheet()!,
            ...
            expect(filterColumn.filteredOutRows!.size).toBe(0);
        });
        ...
        it('should filtered out rows correctly', () => {
            ...
            filterColumn.setCondition({ colId: 0, customFilters: { customFilters: [{ operator: CustomFilterOperator.GREATER_THAN, val: 200 }] } });
            filterColumn.reCalc();
